...
<div class="container">
	...
	<form class="" action="Controller" method="post" enctype="multipart/form-data">
		...
		<div class="mb-3">
			...
			</label> <input type="number" class="form-control" id="cep" name="cep" />
		</div>
	
		<div class="mb-3">
			<label for="exampleFormControlInput1" class="form-label">Estado:
			</label> <input type="text" class="form-control" id="estado" name="estado" value="" disabled="disabled"/>
		</div>

		<div class="mb-3">
			<label for="exampleFormControlInput1" class="form-label">Cidade:
			</label> <input type="text" class="form-control" id="cidade" name="cidade" value="" disabled="disabled"/>
		</div>
		
		<div class="mb-3">
			<label for="exampleFormControlInput1" class="form-label">Endereço (logradouro):
			</label> <input type="text" class="form-control" id="endereco" name="endereco" value="" disabled="disabled"/>
		</div>

		<div class="mb-3">
			<label for="exampleFormControlInput1" class="form-label">Bairro:
			</label> <input type="text" class="form-control" id="bairro" name="bairro" value="" disabled="disabled"/>
		</div>
		
		<div class="mb-3">
			<label for="exampleFormControlInput1" class="form-label">Lote:
			</label> <input type="number" class="form-control" id="numero" name="lote" >
		</div>
